{
	"variables": {
		"lib_dir": "<!(node ./lib/install/getEnv.js OPENCV4NODEJS_LIBRARY_DIR)",
		"etc_dir": "<!(node ./lib/install/getEnv.js OPENCV4NODEJS_LIBRARY_DIR)/../etc",
		"bin_dir": "<!(node ./lib/install/getEnv.js OPENCV4NODEJS_LIBRARY_DIR)/../bin"
	},
	"targets": [
		{
			"target_name": "copies",
		...
		},
		{
			...
			"defines": [
				"<!@(node ./lib/install/getEnv.js OPENCV4NODEJS_DEFINES)",
			],
			"include_dirs" : [
				"<!@(node ./lib/install/getEnv.js OPENCV4NODEJS_INCLUDES)",
				"cc",
				"cc/core",
				"<!(node -e \"require('nan')\")",
